...
function write($phpPowerPoint, $filename, $writers)
{
    ...
    foreach ($writers as $writer => $extension) {
        ...
        if (!is_null($extension)) {
            ...
            $xmlWriter->save(__DIR__ . DIRECTORY_SEPARATOR);
            rename(__DIR__ . "/Sample_Header.php", __DIR__ . "/results/{$filename}.{$extension}");
        } else {
            $result .= ' ... NOT DONE!';
        }
        $result .= EOL;
...
<div class="navbar navbar-default" role="navigation">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="../../../../../Downloads/PhpProject-ba88a76cba2ed4607e97831f5f22d8a2e8a6abb3/PhpProject-ba88a76cba2ed4607e97831f5f22d8a2e8a6abb3/samples">PHPProject</a>
        </div>
